<h2 class="title--komika title--komika__big box">Gestión de Editoriales</h2>
<form name="form_publisher" id="formPublisher" class="main-screen margin-top__50 main--screen__content">
